...
namespace Core.LevelSerialization
{
    public static class LevelSerializer
    {
        ...
        public static (Enum[,] GridObjectTypes, List<LevelGoal> Goals) ProcessLevelJson(LevelJson levelJson)
        {
            ...
            if (numberOfVases != 0)
                goals.Add(new LevelGoal { ObstacleType = ObstacleType.Vase, Count = numberOfVases });
        ...
        public static LevelJson ConvertToLevelJson(int gridWidth, int gridHeight, int moveCount,
            JsonGridObjectType[,] items)
        {
